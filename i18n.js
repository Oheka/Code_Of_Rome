...
const TRANSLATIONS = {
    en: {
        ...
        'input.hint':       'Respect exact punctuation and spaces.',
        'hint.btn':         '⚡ Reveal Shift',
        'grid.title':       '✦ Cipher Alphabet Worksheet ✦',
        'grid.label':       'Cipher →',
        'grid.label2':      'Plain →',
        ...
        'feedback.wrong':   '✗ Incorrect. Try a different shift.',
    ...
    fr: {
        ...
        'hero.description': 'Mettez votre intelligence à l\'épreuve contre le légendaire chiffre de César. Déchiffrez la sagesse romaine antique et prouvez que vous méritez les secrets les mieux gardés de l\'Empire.',
        ...
        'input.hint':       'Respectez la ponctuation exacte et les espaces.',
        'hint.btn':         '⚡ Révéler le Décalage',
        'grid.title':       '✦ Grille de Correspondance ✦',
        'grid.label':       'Chiffré →',
        'grid.label2':      'Clair →',
        'grid.clear':       'Effacer',
...
const HISTORY_TRANSLATIONS = {
    en: {
        ...
        't3.p': "Suetonius records that the Emperor Augustus used a personal cipher: a shift of one position, used for private correspondence. He also noted variations using Greek letters for maximum security.",
        ...
        't5.p': 'The Italian Renaissance polymath invents the cipher disk and introduces the concept of polyalphabetic substitution: multiple Caesar shifts in sequence, as a direct response to the vulnerability of frequency analysis.',
        ...
        'card.puzzle.p': 'From escape rooms to geocaching, from crossword puzzles to ARGs (Alternate Reality Games), the Caesar cipher remains a beloved puzzle mechanic, a nod to history wrapped in playful mystery.',
        ...
        's6.quote': 'The study of cryptography must begin somewhere. And it almost always begins in Rome, with a general who thought to shift his letters, changing the history of secrets forever.',
        ...
        'history':           'History',
        'footer.by':         'Developed by',
        'footer.quote.hist': '"In the beginning was the Word. Caesar encrypted it."',
    },
    ...
    fr: {
        ...
        'card.puzzle.p': 'Des escape rooms au géocaching, des mots croisés aux ARG (jeux de réalité alternée), le chiffre de César reste un mécanisme de puzzle apprécié, un clin d\'œil à l\'histoire enveloppé dans le mystère.',
        ...
        's6.quote': "L'étude de la cryptographie doit commencer quelque part. Et elle commence presque toujours à Rome, avec un général qui eut l'idée de décaler ses lettres, changeant à jamais l'histoire des secrets.",
        's6.cite': '— Code of Rome',
        ...
        'history':           'Histoire',
        'footer.by':         'Développé par',
        'footer.quote.hist': '"Au commencement était le Verbe. César le chiffra."',
    }
};

// ── Core i18n engine ──
let currentLang = 'en';
try { currentLang = localStorage.getItem('corlang') || 'en'; } catch(e) {}
...
function setLang(lang) {
    currentLang = lang;
    try { localStorage.setItem('corlang', lang); } catch(e) {}
    applyTranslations();
...
// Also listen for DOMContentLoaded as a safety net
